...
var runtime = __webpack_require__(/*! @babel/runtime/helpers/regeneratorRuntime */ 106)();
...
/***/ 108:
/*!**********************************************************!*\
  !*** C:/Users/Administrator/Desktop/lxb/utils/config.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 141:
/*!***********************************************************!*\
  !*** C:/Users/Administrator/Desktop/lxb/utils/openDoc.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
exports.openDocumentFromUrl = openDocumentFromUrl;
var _typeof2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/typeof */ 13));
// 统一的在线预览工具：下载 -> openDocument，带 loading、超时、一次重试与失败提示

function openDocumentFromUrl(file) {
  var url = typeof file === 'string' ? file : file.url;
  var fileType = (0, _typeof2.default)(file) === 'object' && file.type ? file.type : '';
  if (!url) {
    uni.showToast({
      title: '文件地址为空',
      icon: 'none'
  ...
  // 微信小程序不支持的文件类型
  var unsupported = ['rar', '7z', 'zip', 'tar', 'gz', 'bz2', 'exe', 'dmg', 'iso', 'bin'];
  var ext = (fileType || url.split('?')[0].split('.').pop() || '').toLowerCase();

  // 微信小程序支持的文件类型
  var supported = ['pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'txt', 'rtf'];
  ...
  var doDownload = function doDownload() {
    ...
    if (!supported.includes(ext)) {
      uni.showModal({
        title: '文件类型可能不支持',
        content: "\u6587\u4EF6\u7C7B\u578B ".concat(ext.toUpperCase(), " \u53EF\u80FD\u65E0\u6CD5\u9884\u89C8\uFF0C\u662F\u5426\u7EE7\u7EED\u5C1D\u8BD5\uFF1F"),
    ...
    uni.downloadFile({
      ...
      success: function success(res) {
        ...
        if (res.statusCode === 200) {
          ...
          if (!retry) {
            ...
            uni.showToast({
              title: "\u4E0B\u8F7D\u5931\u8D25(\u72B6\u6001\u7801:".concat(res.statusCode, ")\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5"),
              icon: 'none'
            });
          }
        }
      ...
      fail: function fail(err) {
        ...
        if (!retry && url.includes('llzm-lixiaobao.oss-cn-beijing.aliyuncs.com')) {
          ...
          var proxyUrl = "https://llzmlxb.xyz/api/proxy-download?url=".concat(encodeURIComponent(url));
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"历小小包","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 26:
/*!*****************************************************!*\
  !*** C:/Users/Administrator/Desktop/lxb/pages.json ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 33:
/*!*******************************************************************!*\
  !*** C:/Users/Administrator/Desktop/lxb/uni.promisify.adaptor.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 40:
/*!*************************************************************!*\
  !*** C:/Users/Administrator/Desktop/lxb/mixins/careMode.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  methods: {
    // 加载关怀模式设置
    loadCareMode: function loadCareMode() {
      var savedCareMode = uni.getStorageSync('careMode');
    ...
    // 应用关怀模式样式
    applyCareMode: function applyCareMode() {
      // 在微信小程序中，通过动态类名来应用关怀模式样式
      console.log('关怀模式状态:', this.careMode ? '已开启' : '已关闭');
    },
    // 切换关怀模式（仅在设置页面使用）
    toggleCareMode: function toggleCareMode() {
